...
exports.ProcessTemplatesModule = ProcessTemplatesModule = __decorate([
    (0, common_1.Module)({
        controllers: [process_templates_controller_1.ProcessTemplatesController],
        providers: [process_templates_service_1.ProcessTemplatesService],
    })
], ProcessTemplatesModule);
//# sourceMappingURL=process-templates.module.js.map